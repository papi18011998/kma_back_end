...
public class SecurityConstant {
    ...
    public static final String GET_ARRAYS_ADMINISTRATION = "Suivi de notes Keur Maman Anthiou";
    ...
    public static final String[] PUBLIC_URLS = {"/users/login","/swagger-ui/**","/v3/api-docs/**","/eleves/**"};
}
